...
const ShimmerButton = React.forwardRef<HTMLButtonElement, ShimmerButtonProps>(
    ({
        ...
        const variantClasses = {
            default: [
                'bg-[#13A495]', // Primary color requested
                'hover:bg-[#13A495]/90',
        ...
        return (
            <Comp
                ...
                className={cn(
                    ...
                    // 3D button effect
                    'shadow-[inset_0_0_0.1rem_0_rgba(255,255,255,0.2),0_0.3rem_0.1rem_-0.2rem_rgba(0,0,0,0.5)]',

                    // Hover effects
                    'hover:translate-y-[-2px] hover:shadow-[0_0_20px_rgba(19,164,149,0.5)]',
